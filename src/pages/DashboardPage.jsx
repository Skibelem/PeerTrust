...
import { Shield, LogOut, Wallet, User, Bug, HelpCircle, ArrowRight, Store, PlusCircle, List, RefreshCw } from 'lucide-react'
    ...
    <div className="bg-slate-50 min-h-screen">
      ...
      <nav className="bg-slate-900 text-white shadow-sm py-4 px-6 md:px-12 flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-xl tracking-tight text-white">PeerTrust Dashboard</span>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-12 py-10 space-y-8">
        ...
        <div className="bg-teal-50 border border-teal-200 rounded-2xl p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-sm animate-fade-in">
          <div className="space-y-1">
            <h4 className="font-bold text-teal-900 flex items-center gap-1.5 text-sm">
              ...
              Supabase Auth Foundation Successful
            </h4>
            <p className="text-xs text-teal-700 max-w-xl leading-relaxed">
              Your session is authenticated via Supabase. Profile metadata sync, active roles redirect, and database wallet initialization are fully operational.
            </p>
          </div>
          <Link
            to="/profile-debug"
        ...
        <div className="bg-white border border-slate-100 rounded-3xl p-6 md:p-8 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="flex gap-4 items-center">
            ...
            <div>
              ...
              <p className="text-slate-500 text-sm mt-1">{profile?.email || 'Checking email...'}</p>
              {profile?.phone && <p className="text-slate-400 text-xs mt-0.5">Phone: {profile.phone}</p>}
            </div>
          </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              title="Refresh wallet balances from Supabase"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-slate-100 rounded-3xl p-6 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
              ...
              <p className="text-[10px] text-slate-500 mt-4 border-t border-slate-50 pt-2">
                Simulated balance initialized on DB registration.
              </p>
            </div>
            ...
            <div className="bg-white border border-slate-100 rounded-3xl p-6 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
              ...
              <p className="text-[10px] text-slate-500 mt-4 border-t border-slate-50 pt-2">
                Locked funds secured from transaction orders.
              </p>
            </div>

            {/* Pending Withdrawal */}
            <div className="bg-white border border-slate-100 rounded-3xl p-6 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
              <div className="absolute top-0 right-0 h-24 w-24 bg-red-50 rounded-full blur-2xl opacity-40 -mr-8 -mt-8"></div>
              <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider">
              ...
              <p className="text-[10px] text-slate-500 mt-4 border-t border-slate-50 pt-2">
                Requests pending administrator approval.
              </p>
            </div>
          </div>
        </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-xs mt-0.5">Browse all active seller offers</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-xs mt-0.5">View all your active and past trades</p>
                </div>
              </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 text-xs mt-0.5">Post a service or product for buyers</p>
                  </div>
                </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 text-white relative overflow-hidden shadow-md">
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-bold text-white text-md">Demo Mode Notice</h3>
              <p className="text-xs text-slate-300 mt-2 leading-relaxed max-w-3xl">
                This is a prototype sandbox environment. All wallet balances, active/completed trades, deposits, withdrawals, and escrow operations are fully simulated in our public schema databases. No actual payment processing or real fiat withdrawals are integrated or stored on this platform.
              </p>
            </div>
          </div>
        </div>
